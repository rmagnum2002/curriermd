...
ActiveRecord::Schema.define(version: 2018_09_30_172040) do
  ...
  create_table "authorships", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci", force: :cascade do |t|
